...
class FaceCaptureApp:
    def __init__(self, master):
        ...
        self.bg_image = Image.open("C:\\Users\\Alejandro Padilla\\Documents\\Programacion\\POO\\Sistema-de-Reconocimiento-Facial\\Temas\\fondo.png")
        self.bg_image = self.bg_image.resize((800, 500), Image.LANCZOS)  # Ajustar el tamaño
        ...
        self.label = tk.Label(master, text="Ingrese Documento (Empleado)", bg='white', font=("Roboto Black", 12, "bold"))  # Fondo blanco para el texto
        self.label.place(x=140, y=95, width=350, height=20)

        self.entry = tk.Entry(master)
        self.entry.place(x=175, y=127, width=270, height=20)

        self.video_button = tk.Button(master, text="Seleccionar Video", command=self.select_video, font=("Roboto Black", 12, "bold"))
        self.video_button.place(x=160, y=230, width=305, height=40)

        self.start_button = tk.Button(master, text="Iniciar Grabación", command=self.start_capture, font=("Roboto Black", 12, "bold"))
        self.start_button.place(x=160, y=302, width=305, height=40)

        self.quit_button = tk.Button(master, text="Regresar", command=master.quit, font=("Roboto Black", 12, "bold"),fg="black", bg="#ff6600")
        self.quit_button.place(x=160, y=385, width=305, height=40)

        self.training_button = tk.Button(master, text = "Entrenar Modelo",)
    ...
    def start_capture(self):
        ...
        dataPath = 'C:\\Users\\Alejandro Padilla\\Documents\\Programacion\\POO\\Sistema-de-Reconocimiento-Facial\\Data'  # Cambia a la ruta donde hayas almacenado Data
    ...
    def capture_faces(self):
        while True:
            ...
            faces = self.faceClassif.detectMultiScale(gray, 1.1, 10)
            ...
            cv2.putText(frame, "Presiones esc para detener la grabacion", (10,450), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
